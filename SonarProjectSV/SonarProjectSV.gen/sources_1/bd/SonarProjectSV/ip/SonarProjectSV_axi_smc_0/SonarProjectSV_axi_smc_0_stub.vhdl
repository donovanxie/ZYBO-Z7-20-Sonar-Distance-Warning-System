...
-- Command     : write_vhdl -force -mode synth_stub -rename_top SonarProjectSV_axi_smc_0 -prefix
--               SonarProjectSV_axi_smc_0_ SonarProjectSV_axi_smc_0_stub.vhdl
...
entity SonarProjectSV_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of SonarProjectSV_axi_smc_0 : entity is "SonarProjectSV_axi_smc_0,bd_c236,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of SonarProjectSV_axi_smc_0 : entity is "SonarProjectSV_axi_smc_0,bd_c236,{x_ipProduct=Vivado 2024.2.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=26,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of SonarProjectSV_axi_smc_0 : entity is "yes";
end SonarProjectSV_axi_smc_0;

architecture stub of SonarProjectSV_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN SonarProjectSV_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:M01_AXI:M02_AXI:M03_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_INTERFACE_PARAMETER of M02_AXI_awaddr : signal is "XIL_INTERFACENAME M02_AXI, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 50000000, ID_WIDTH 0, ADDR_WIDTH 7, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 8, NUM_WRITE_OUTSTANDING 8, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN SonarProjectSV_processing_system7_0_0_FCLK_CLK0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_c236,Vivado 2024.2.1";
begin
end;
