...
#ifndef _PmodMAXSONAR_xlslice_0_0_core_h_
#define _PmodMAXSONAR_xlslice_0_0_core_h_

#include <systemc.h>
#include "properties.h"


class PmodMAXSONAR_xlslice_0_0_core : public sc_module 
{
    public: 
       PmodMAXSONAR_xlslice_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(PmodMAXSONAR_xlslice_0_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~PmodMAXSONAR_xlslice_0_0_core() = default;
