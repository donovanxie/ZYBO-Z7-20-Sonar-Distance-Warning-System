...
//Command     : generate_target SonarProjectSV_wrapper.bd
//Design      : SonarProjectSV_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module SonarProjectSV_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  SonarProjectSV SonarProjectSV_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
        ...
        .DDR_we_n(DDR_we_n),
        .DistanceValue_tri_o(DistanceValue_tri_o),
